...
-- Lighthouse Cash Book Database Schema - Updated Version
...
-- Transactions table (updated with time field)
...
-- Messages table (new for chat functionality)
...
-- Insert default categories (updated with Rent Paid)
